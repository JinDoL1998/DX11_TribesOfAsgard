...
HRESULT CLoading_BackGround::Ready_Components()
{
	...
	/* Com_Texture */
	if (FAILED(__super::Add_Component(ENUM_CLASS(LEVEL::STATIC), TEXT("Prototype_Component_Texture_Loading_BackGround"),
...
HRESULT CLoading_BackGround::Bind_ShaderResources()
{
...
CGameObject* CLoading_BackGround::Clone(void* pArg)
{
	...
	{
		MSG_BOX("Failed to Cloned : CLoading_BackGround");
		Safe_Release(pInstance);
	}
